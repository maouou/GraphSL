...
def parse_args():
    ...
    parser.add_argument('--pretrain_net', type=str, choices=['GCN', 'GAT', 'SAGE'], default='GCN', help='pretrain GNN bachbone')
    ...
    parser.add_argument('--a', type=float, default=0.9, help='hyper-paramter α')
    ...
    parser.add_argument('--no_mas_k', action="store_true", help='whether to mask the self class in sampling neighbor classes. default is mask')
